...
import { EachNicknameEdit } from './pages/chat/eachNicknameEdit.tsx';
import { Admin } from './pages/home/admin.tsx';
...
export const MainRouter: React.FC = () => {
    return (
        <Routes>
            ...
            <Route path="/eachNicknameEdit" element={<EachNicknameEdit />} />
