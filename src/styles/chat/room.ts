...
export const ChatTutorialTextContainer = styled.div`
    width: fit-content;
    display: flex;
    flex-direction: column;
...
//////ReplyTutorial//////
export const ReplyTutorialContainer = styled.div`
    width: 100%;
    height: 100%;
    position: fixed;
    top: 0;
...
export const ReplyTutorialTextContainer = styled.div`
    width: fit-content;
    display: flex;
    flex-direction: column;
    justify-content: center;
...
export const ReplyTutorialText = styled.div`
    font-size: 1.3rem;
    font-weight: 700;
    color: white;
    margin: 0.2rem 0;
...
export const ReplyTutorialButton = styled.div`
    background: #b3b0b1;
    border: 0.2rem solid white;
    border-radius: 1rem;
    color: white;
