...
export const Main = () => {
    ...
    const filteredCharacters =
        selectedGenre === 'all' ? characters : characters.filter((character: any) => character.genre === selectedGenre);
    ...
    return (
        <S.Container style={{ overflow: isTutorial ? 'hidden' : 'scroll' }}>
            {isTutorial && (
                <S.TutorialContainer>
                    <S.TutorialTextContainer>
                        ...
                        <S.TutorialButton onClick={() => setIsTutorial(false)}>OK</S.TutorialButton>
                    </S.TutorialTextContainer>
                </S.TutorialContainer>
            )}
            ...
            <S.NavContainer>
                <S.ButtonNav>
                    <S.StyledButton active={selectedGenre === 'all'} onClick={() => setSelectedGenre('all')}>
                        전체
                    </S.StyledButton>
                    <S.StyledButton active={selectedGenre === 'anime'} onClick={() => setSelectedGenre('anime')}>
                        애니
                    </S.StyledButton>
                    <S.StyledButton active={selectedGenre === 'game'} onClick={() => setSelectedGenre('game')}>
                        게임
                    </S.StyledButton>
                </S.ButtonNav>
                <S.ImageContainer>
