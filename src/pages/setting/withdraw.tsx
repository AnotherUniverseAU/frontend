    ...
    return (
        <S.Container>
                ...
                <S.StyledModal open={isModalOpen}>
                    <S.ModalContainer>
                        ...
                        <S.ModalButtonContainer>
                            <S.ModalLeftButton onClick={realWithdrawTrue}>탈퇴</S.ModalLeftButton>
            ...
            <S.SubContainer>
                ...
                <S.ReplyContainer>
                    {selectedOption === 1 && (
                        <S.Reply>
                            AU는 {}
                            <b>캐릭터의 미공개 영상, GIF, 미공개 만화/일러스트를 빠른 시일 내에 런칭</b>
                            할 예정입니다. <br /> <br />
                            나아가 캐릭터의 페르소나를 강화하고 컨텐츠를 확대하기 위해 {}
                            <b>지속적으로 노력</b>하고 있으니, AU를 조금만 더 이용해 보시는건 어떨까요?
                        </S.Reply>
                    )}
                    {selectedOption === 2 && (
                        <S.Reply>
                    ...
                    {selectedOption === 3 && (
                        <S.Reply>
                            ...
                            AU는 이용자님의 {}
                            <b>개인정보 보호를 위해 최선</b>을 다하고 있으니, AU를 조금만 더 이용해 보시는건 어떨까요?
                        </S.Reply>
                    )}{' '}
                    {selectedOption === 4 && (
                        <S.Reply>
                            사용하면서 <b>불편하셨던 내용</b>을 알려주시면 더 나은 서비스를 제공할 수 있도록
                            노력하겠습니다.
                        </S.Reply>
                    )}
                </S.ReplyContainer>
                ...
                {complain && selectedOption === 4 && (
                    <S.ComplainReplyContainer>
                        <S.ComplainReply>
                            이용자님의 불편 사항을 이해했습니다. 해당 불편 사항을 빠르게 해결 할 예정이니, AU를 조금만
                            더 이용해 보시는건 어떨까요?
                        </S.ComplainReply>
                    </S.ComplainReplyContainer>
                )}
            ...
            {(selectedOption === 1 ||
                ...
                (complain && selectedOption === 4)) && (
                <S.FooterContainer>
                    <S.WithdrawButton onClick={openModal}>그래도 탈퇴할래요</S.WithdrawButton>
